...
Definição de sucesso: O sucesso da intervenção será definido como uma redução estatisticamente significativa do score do PHQ-9 às 8 semanas no grupo de intervenção comparativamente ao grupo controlo. Considerar-se-á uma diferença clinicamente significativa (MCID) uma redução de pelo menos 5 pontos no score total (Löwe et al., 2004). Adicionalmente, será explorada a proporção de participantes que atingem remissão sintomática, definida como PHQ-9 < 5.
...
- Löwe B, Unützer J, Callahan CM, Perkins AJ, Kroenke K. Monitoring depressive symptoms over time: interpretation of changes in patient health questionnaire scores. Med Care. 2004;42(12):1194-1201.


# Downloads do Protocolo

* [📦 Projeto Markdown (ZIP)](protocolo_entrega/protocolo_md.zip)
* [📦 Projeto LaTeX (ZIP)](protocolo_entrega/protocolo_latex.zip)
* [📦 Projeto Word](protocolo_word.docx)
